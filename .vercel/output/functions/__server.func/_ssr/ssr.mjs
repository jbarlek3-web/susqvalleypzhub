...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-WxaQ-bpD.mjs");
...
var manifest = {
	"207f4c58f494037067199d147cf9867d5c710e7b2c76804513f527979a0741c2": {
		functionName: "analyzeParcel_createServerFn_handler",
		importer: () => import("./grok-analyze-DNfgIKxB.mjs")
	},
	"b01695d343379842625bd1402efa65e533666bc4f1903c7ca8c5787c15f4f6a8": {
		functionName: "confirmCheckout_createServerFn_handler",
		importer: () => import("./stripe-confirm-CaqtDPSP.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BvpTSFY9.mjs").then((n) => n.t),
